...
INSERT INTO authors (first_name, last_name, patronymic_name, short_biography, born_date, rating) VALUES
('Daniel', 'Defoe', '', 'He was a great writer.', '1660-01-08', '0.0');
...
INSERT INTO categories (name) VALUES ('for adult'), ('for children');
...
INSERT INTO genre (name) VALUES ('Detective'), ('Adventure');
...
VALUES
('ROLE_USER'), ('ROLE_MODERATOR'), ('ROLE_ADMIN'), ('ROLE_SUPERADMIN');
...
INSERT INTO books (title, author_id, genre_id, category_id, pages, format, year_of_writing,
                   origin_language, publisher, rating) VALUES
('Robinson Crusoe', 1, 1, 1, 120, 'story', 1820, 'English', 'Neva', 10.0);
...
CREATE TABLE books_images (
                              id           			bigserial PRIMARY KEY,
                              book_id      			bigint, FOREIGN KEY (book_id) REFERENCES books (id),
                              path         			varchar(255));

INSERT INTO books_images (book_id, path) VALUES
(1, '1png'),
(1, '2png');
...
INSERT INTO feedback (title, author_feedback, genre_own_opinion, category_own_opinion, book_feedback, book_character, main_theme, detailed_feedback, canvas, overall_impression, overall_mark, feedback_visibility, date, feedback_rating) VALUES
('Robinson Crusoe', 'I respect this writer!', 'bromance', 'for teenagers', 'He did it! I was on that island with the poor guy in my mind!', 'Robi, Friday','alone on uninhabitated island', 'You must read it!', '!!!!!!', 'excellent', '10', 'public', '2018-01-30 10:06:22', 10.0);
